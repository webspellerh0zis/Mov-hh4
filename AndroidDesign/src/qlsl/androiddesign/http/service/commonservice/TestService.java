...
public class TestService extends BaseService {
	...
	private static String className = getClassName(TestService.class);

	public static void getVersionInfo(final FunctionView<?> functionView,
			...
			public void run() {
				...
				try {
					JSONObject jo = protocol
							.setMethod("system_manifest")
							.addParam("type", "30").get();
