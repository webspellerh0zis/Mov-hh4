...
/**
 * by yql at 20151119<br/>
 * 自适应ViewPager的FragmentTabHost<br/>
 * 修复了传统的FragmentTabHost+ViewPager实现滑动性遗留下的重复加载Fragment的bug<br/>
 * 必须设置ViewPager的预加载数量为剩下总数，以适应点击TAB的同步改变问题，但由于TabHost原因，不会真正预加载剩下数量<br/>
 * 未解决连带的黑影问题：可更改ViewPager背景改变黑影颜色，但ViewPager的左右切换动画没有效果<br/>
 * 此类作为折中方案的参考，不建议使用，选项卡的滑动建议使用纯ViewPager<br/>
 */
@SuppressLint("NewApi")
public class WrapFragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
	...
	public WrapFragmentTabHost(Context context) {
	...
	public WrapFragmentTabHost(Context context, AttributeSet attrs) {
		super(context, attrs);
