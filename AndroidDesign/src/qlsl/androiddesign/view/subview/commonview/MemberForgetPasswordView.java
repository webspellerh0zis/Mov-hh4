 ...
 * 是否必传 ：
 */
public class MemberForgetPasswordView extends FunctionView<MemberForgetPasswordActivity> {
	...
	public MemberForgetPasswordView(MemberForgetPasswordActivity activity) {
		super(activity);
		setContentView(R.layout.activity_member_forget_password_new);
	}
	...
	private void doClickFinishButton() {
		String phone = et_phone.getText().toString();
		...
		MemberService.resetPasswordBySMSCode(phone, code, password, this, activity);
	}
