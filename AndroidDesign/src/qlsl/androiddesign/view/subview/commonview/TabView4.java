...
public class TabView4 extends FunctionView<MainActivity> {

	public TabView4(FragmentTab4 fragment, ViewGroup rootView, ViewGroup contentView) {
		super((MainActivity) fragment.getActivity());
		setContentView(rootView, contentView);
	}

	protected void initView(View view) {
		setTitle(activity.getResources().getString(R.string.tab4));
	}
