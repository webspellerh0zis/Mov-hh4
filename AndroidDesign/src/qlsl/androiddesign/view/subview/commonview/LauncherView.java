 ...
 * 引导页<br/>
 */
public class LauncherView extends FunctionView<LauncherActivity> implements
	...
	protected void initView(View view) {
		...
		indicatorView = (IndicatorView) view
				.findViewById(R.id.net_indicate_view);
		indicatorView.setIndicateStyle(IndicatorView.INDICATE_ROUND_STYLE);
		iv_launcher = (ImageView) view.findViewById(R.id.iv_launcher);
	}

	protected void initData() {
		Boolean isFirstStart = (Boolean) SPUtils.get(activity,
				SPUtils.IS_FIRST_START, true);
		if (isFirstStart) {
			Integer[] resArray = new Integer[] { R.drawable.suggest_01,
					R.drawable.suggest_02, R.drawable.suggest_03 };
