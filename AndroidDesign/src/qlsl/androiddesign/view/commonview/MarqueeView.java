...
import com.qlsl.androiddesign.appname.BuildConfig;
...
/**
 * LinearLayout作为父View，必须有一个子TextView<br/>
 * 
 * 利用动画实现
 */
public class MarqueeView extends LinearLayout {
	...
	private void prepareAnimation() {
		...
		if (BuildConfig.DEBUG) {
			Log.d(TAG, "(int) Math.abs(startXOfOut - endXOfOut)       : " + (int) Math.abs(startXOfOut - endXOfOut));
