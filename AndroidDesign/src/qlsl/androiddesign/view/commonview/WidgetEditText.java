...
/**
 * 点击弹出输入法，点击关闭输入法，禁止了长按时的调试缩略窗<br/>
 * 艺术字体EditText<br/>
 * 开启点击事件<br/>
 * 清除按钮<br/>
 */
public class WidgetEditText extends android.widget.EditText {
	...
	public WidgetEditText(Context context, AttributeSet attrs, int defStyle) {
