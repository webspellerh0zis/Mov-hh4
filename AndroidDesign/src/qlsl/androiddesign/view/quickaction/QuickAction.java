package qlsl.androiddesign.view.quickaction;
...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	public void addActionItem(ActionItem action) {
		...
		if (mOrientation == HORIZONTAL && mChildPos != 0) {
			View separator = mInflater.inflate(R.layout.horizontal_separator,
					null);
	...
	/**
	 * 从window中显示QuickAction，只支持竖直方向，by ylq 2015-02-26<br/>
	 */
	@SuppressLint("NewApi")
	public void showFromWindow(View anchor) {
		this.anchor = anchor;
		...
		int xPos = (int) (anchor.getX() + (anchor.getWidth() / 2) - anchorRect
				.width());
		int yPos = (int) (anchor.getY() + anchor.getHeight());
		int arrowPos = anchorRect.width();
	...
	private void showArrow(int whichArrow, int requestedX) {
		final View showArrow = (whichArrow == R.id.arrow_up)
				? mArrowUp
				: mArrowDown;
		final View hideArrow = (whichArrow == R.id.arrow_up)
				? mArrowDown
				: mArrowUp;
