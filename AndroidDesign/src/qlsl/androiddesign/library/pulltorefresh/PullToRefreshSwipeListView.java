...
/**
 * 使用二次拦截监听技术以达到扩展类的中间处理，避免修改基类<br/>
 * 二次拦截能实现中间层的事件处理，且不会影响基层，也避免在运行层进行无法公用的冗杂处理<br/>
 * by ylq at 20151208<br/>
 */
public class PullToRefreshSwipeListView extends PullToRefreshAdapterViewBase<SwipeListView> {
	...
	private void init() {
		setOnScrollListener(holdScrollListener);
	}
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
			...
			OverscrollHelper.overScrollBy(PullToRefreshSwipeListView.this, deltaX, scrollX, deltaY, scrollY,
					isTouchEvent);
	 ...
	 * 设置此滑动监听便于二次拦截<br/>
	 */
	public void setOnSwipeScrollListener(OnScrollListener onScrollListener) {
		this.onScrollListener = onScrollListener;
	}

	/**
	 * 二次拦截监听，用于滑动时关闭打开的item,by ylq at 20151208<br/>
	 */
	private AbsListView.OnScrollListener holdScrollListener = new AbsListView.OnScrollListener() {

		public void onScrollStateChanged(AbsListView view, int scrollState) {
			getRefreshableView().resetOpened();
