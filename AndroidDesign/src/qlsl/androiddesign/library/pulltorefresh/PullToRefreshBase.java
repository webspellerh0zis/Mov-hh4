...
import qlsl.androiddesign.library.pulltorefresh.internal.FlipLoadingLayout;
import qlsl.androiddesign.library.pulltorefresh.internal.LoadingLayout;
import qlsl.androiddesign.library.pulltorefresh.internal.RotateLoadingLayout;
import qlsl.androiddesign.library.pulltorefresh.internal.Utils;
import qlsl.androiddesign.library.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	public final void onLoadComplete(int totalPage, int totalCount) {
		String info = "数据加载已完毕\n总页数：" + totalPage + "  总数据量：" + totalCount;
		setRefreshingLabel(info);
		onRefreshComplete();
	}
	 ...
	 *            总条目数
	 * 
	 * @see 如果需求上不让显示此releaseLabel，可用Log里面的调试模式/发布模式控制其显示时机<br/>
	 *      加载完成提示同此<br/>
	 */
	public void setReleaseLabel(int pageNo, int pageSize, long totalPage,
			long totalCount) {
		String releaseLabel = "当前页：" + pageNo + "  当前数据：" + pageSize + "\n总页数："
				+ totalPage + "  总数据量：" + totalCount;
