...
public class BasicSettingToggleButtonPreference extends Preference {
	...
	private static final int[] icons = new int[]{
			R.drawable.basic_setting_icon1, R.drawable.basic_setting_icon2,
			R.drawable.basic_setting_icon3, R.drawable.basic_setting_icon4,
			R.drawable.basic_setting_icon5, R.drawable.basic_setting_icon6,
			R.drawable.basic_setting_icon7};
	...
	public BasicSettingToggleButtonPreference(Context context,
			AttributeSet attrs) {
		super(context, attrs);
