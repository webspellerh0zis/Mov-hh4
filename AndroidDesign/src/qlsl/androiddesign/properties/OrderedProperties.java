package qlsl.androiddesign.properties;
...
public class OrderedProperties extends Properties {
	...
	/**
	 * 作为Map获取键值对 by ylq 2015-02-26<br/>
	 */
	...
	/**
	 * 给键和值各分配一个指定键作为装载Map的List返回 by ylq 2015-02-26<br/>
	 * 实时获取不断更新的Properties<br/>
	 */
	public void updateList(List<Map<String, Object>> list, String keyKey,
			String keyValue) {
		list.clear();
		Iterator<Entry<Object, Object>> it = entrySet().iterator();
		while (it.hasNext()) {
	...
	public List<Map<String, Object>> getList(String keyKey, String keyValue) {
